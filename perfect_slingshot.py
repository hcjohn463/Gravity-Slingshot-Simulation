...
class PerfectSlingshot:
    def __init__(self, realistic_mode=False):
        ...
        if realistic_mode:
            ...
            # Optimized trajectory for realistic slingshot
            ...
            # Position for perfect slingshot approach
        ...
        # Spacecraft parameters - optimized for slingshot
        ...
        print(f"Mode: {'Realistic (10x mass)' if realistic_mode else 'Enhanced (50x mass)'}")
    ...
    def run_simulation(self, max_steps=300):
        ...
        print("Running optimized slingshot simulation...")
    ...
    def create_animation(self):
        ...
        ax1.set_title('Gravity Slingshot Effect', fontsize=20, color='white', pad=20)
...
def main():
    print("🚀 Perfect Gravity Slingshot Simulation")
    print("=" * 50)
    
    print("\nChoose simulation mode:")
    print("1. Enhanced mode (Moon mass x50) - Dramatic U-turn slingshot effect [DEFAULT]")
    print("2. Realistic mode (Moon mass x10) - Moderate slingshot with escape")
    print("3. Auto-run Enhanced mode")
    
    while True:
        choice = input("\nSelect mode (1/2/3) [Press Enter for Enhanced]: ").strip()
    ...
    if choice == '3':
        ...
        print("Running Enhanced mode automatically...")
    else:
        realistic_mode = (choice == '2')
    
    # Initialize simulation
    sim = PerfectSlingshot(realistic_mode=realistic_mode)
    
    print(f"\n{'='*60}")
    print("Physics Explanation:")
    print("• Enhanced mode: Exaggerated gravity for dramatic visual effect")
    print("• Shows the classic 'U-turn' trajectory that makes slingshots famous")
    print("• Realistic mode: More moderate parameters, still shows slingshot physics")
    print("• Both demonstrate: speed increase + direction change = gravity assist")
    print(f"{'='*60}")
    ...
    if final_speed <= escape_vel_at_final:
        ...
        print("   In reality, this creates bound orbits around the gravitating body")
    else:
        print("✅ Spacecraft successfully escaped! This is proper gravity slingshot effect")
        print("💡 The spacecraft gained speed and changed direction - classic gravity assist!")
    
    # Create visualization
    print("\n🎬 Generating animation...")
    if choice != '3':
        fig, anim = sim.create_animation()
        print("🎥 Displaying slingshot maneuver...")
        plt.show()
        
        # Save option
        save_option = input("\n💾 Save animation as GIF? (y/n): ")
        if save_option.lower() == 'y':
            filename = f'slingshot_{"realistic" if realistic_mode else "enhanced"}.gif'
        ...
        print("🎯 Auto-run complete - skipping animation display")
